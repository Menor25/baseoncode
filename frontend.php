...
<?php
    $frontend = array("name" => "Theophilus Menor", "stack" => "Frontend", 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="profile-info">
                                                    <h5><a href="#"><?= $frontend['name']; ?></a></h5>
                                                    <div class="author-career">Lead Mentor / Instructor</div>
                                                    <p class="author-bio"><?= $frontend['desc'] ?></p>


                                                    <ul class="author-social-networks">
                                                        <?php 
                                                            if($frontend['socials']['twitter'] != "") {

                                                        ?>
                                                            <li class="item">
                                                                <a href="<?= $frontend['socials']['twitter']; ?>" target="_blank" class="social-link"> <i class="fab fa-twitter social-link-icon"></i> </a>
                                                            </li>
                                                        <?php
                                                            }
                                                        ?>
                                                        <?php 
                                                            if($frontend['socials']['facebook'] != "") {
                                    ...
                                    <div class="sidebar-entry-course-info">
                                        ...
                                        <div class="course-meta">
                                            <div class="course-instructor">
                                                ...
                                                <span class="meta-value"><?= $frontend['name'] ?></span>
                                            </div>
