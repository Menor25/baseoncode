...
$content_writing = array("name" => "Ikechukwu Ani", "stack" => "Content Writing", 
                        "desc" => "Ikechukwu Ani is an excellent Relationship Blogger, Public Speaker, Content Creator, and an Instructor",
                        "socials" => array("facebook" => "https://www.facebook.com/ikechukwu.ani.338", "twitter" => "https://twitter.com/officialikeani", "linkedin" => "", "instagram" => "https://www.instagram.com/theanisfamily", "youtube" => ""));
    //print_r($content_writing);
    //echo $content_writing['name'];
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="profile-image">
                                                    <img src="assets/images/profile/ik.jpg" alt="profile">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="profile-info">
                                                    <h5><a href="#"><?= $content_writing['name']; ?></a></h5>
                                                    <div class="author-career">Mentor / Instructor</div>
                                                    <p class="author-bio"><?= $content_writing['desc'] ?></p>


                                                    <ul class="author-social-networks">
                                                        <?php 
                                                            if($content_writing['socials']['twitter'] != "") {

                                                        ?>
                                                            <li class="item">
                                                                <a href="<?= $content_writing['socials']['twitter']; ?>" target="_blank" class="social-link"> <i class="fab fa-twitter social-link-icon"></i> </a>
                                                            </li>
                                                        <?php
                                                            }
                                                        ?>
                                                        <?php 
                                                            if($content_writing['socials']['facebook'] != "") {

                                                        ?>
                                                        <li class="item">
                                                            <a href="<?= $content_writing['socials']['facebook']; ?>" target="_blank" class="social-link"> <i class="fab fa-facebook-f social-link-icon"></i> </a>
                                                        </li>
                                                        <?php
                                                            }
                                                        ?>
                                                        <?php 
                                                            if($content_writing['socials']['linkedin'] != "") {

                                                        ?>
                                                        <li class="item">
                                                            <a href="<?= $content_writing['socials']['linkedin']; ?>" target="_blank" class="social-link"> <i class="fab fa-linkedin social-link-icon"></i> </a>
                                                        </li>
                                                        <?php
                                                            }
                                                        ?>
                                                        <?php 
                                                            if($content_writing['socials']['instagram'] != "") {

                                                        ?>
                                                        <li class="item">
                                                            <a href="<?= $content_writing['socials']['instagram']; ?>" target="_blank" class="social-link"> <i class="fab fa-instagram social-link-icon"></i> </a>
                                                        </li>
                                                        <?php
                                                            }
                                                        ?>
                                                        <?php 
                                                            if($content_writing['socials']['youtube'] != "") {

                                                        ?>
                                                        <li class="item">
                                                            <a href="<?= $content_writing['socials']['youtube']; ?>" target="_blank" class="social-link"> <i class="fab fa-youtube social-link-icon"></i> </a>
                                                        </li>
                                                        <?php
                                                            }
                                                        ?>
                                    ...
                                    <div class="sidebar-entry-course-info">
                                        ...
                                        <div class="course-meta">
                                            <div class="course-instructor">
                                                ...
                                                <span class="meta-value"><?= $content_writing['name'] ?></span>
                                            </div>
