                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="profile-info">
                                                    <h5><a href="profile.html">Theophilus Menor</a></h5>
                                                    <div class="author-career">Lead Mentor / Instructor</div>
                                                    <p class="author-bio">Menor is a brilliant educator and mentor, who has spent most of his life writing code in diverse programming languages. Being a full-stack self taught programmer, he encountered a lot of obstacles and set back. With a true spirit and talented gift, he was able to succeed and set an example for others.</p>


                                                    <ul class="author-social-networks">
                                                        <li class="item">
                                                            <a href="https://twitter.com/DevMenor" target="_blank" class="social-link"> <i class="fab fa-twitter social-link-icon"></i> </a>
                                                        </li>
                                                        <li class="item">
                                    ...
                                    <div class="sidebar-entry-course-info">
                                        <div class="course-price">
                                            ...
                                            <span class="meta-value">
                                                <span class="price"><span>&#x20A6;</span>5000 ($10)</span>
                                            </span>
                                        </div>
                                        <div class="course-meta">
                                            <div class="course-instructor">
                                                ...
                                                <span class="meta-value">Theo Menor</span>
                                            </div>
                                            ...
                                            <div class="course-time">
                                                ...
                                                <span class="meta-value">20th August, 2022</span>
                                            </div>
                                        </div>
                                        <div class="lp-course-buttons">
                                            <a href="register" class="btn btn-primary btn-hover-secondary btn-width-100">Enroll</a>
                                        </div>
