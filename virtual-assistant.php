...
$virtual_assistant = array("name" => "Cynthia Osarumwense Udoh", "stack" => "Virtual Assistant", 
                        "desc" => "Cynthia Udoh is a great Content Writer, Virtual Assistant, Mentor, Product Manager and Community Manager.",
                        "socials" => array("facebook" => "", "twitter" => "https://twitter.com/abbaslover_", "linkedin" => "https://www.linkedin.com/in/osarumwense-cynthia-udoh/", "instagram" => "https://www.instagram.com/cindyflamez", "youtube" => ""));
    //print_r($virtual_assistant);
    //echo $virtual_assistant['name'];
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="profile-image">
                                                    <img src="assets/images/profile/cynthia.jpg" alt="profile">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="profile-info">
                                                    <h5><a href="#"><?= $virtual_assistant['name']; ?></a></h5>
                                                    <div class="author-career">Mentor / Instructor</div>
                                                    <p class="author-bio"><?= $virtual_assistant['desc'] ?></p>


                                                    <ul class="author-social-networks">
                                                        <?php 
                                                            if($virtual_assistant['socials']['twitter'] != "") {

                                                        ?>
                                                            <li class="item">
                                                                <a href="<?= $virtual_assistant['socials']['twitter']; ?>" target="_blank" class="social-link"> <i class="fab fa-twitter social-link-icon"></i> </a>
                                                            </li>
                                                        <?php
                                                            }
                                                        ?>
                                                        <?php 
                                                            if($virtual_assistant['socials']['facebook'] != "") {

                                                        ?>
                                                        <li class="item">
                                                            <a href="<?= $virtual_assistant['socials']['facebook']; ?>" target="_blank" class="social-link"> <i class="fab fa-facebook-f social-link-icon"></i> </a>
                                                        </li>
                                                        <?php
                                                            }
                                                        ?>
                                                        <?php 
                                                            if($virtual_assistant['socials']['linkedin'] != "") {

                                                        ?>
                                                        <li class="item">
                                                            <a href="<?= $virtual_assistant['socials']['linkedin']; ?>" target="_blank" class="social-link"> <i class="fab fa-linkedin social-link-icon"></i> </a>
                                                        </li>
                                                        <?php
                                                            }
                                                        ?>
                                                        <?php 
                                                            if($virtual_assistant['socials']['instagram'] != "") {

                                                        ?>
                                                        <li class="item">
                                                            <a href="<?= $virtual_assistant['socials']['instagram']; ?>" target="_blank" class="social-link"> <i class="fab fa-instagram social-link-icon"></i> </a>
                                                        </li>
                                                        <?php
                                                            }
                                                        ?>
                                                        <?php 
                                                            if($virtual_assistant['socials']['youtube'] != "") {

                                                        ?>
                                                        <li class="item">
                                                            <a href="<?= $virtual_assistant['socials']['youtube']; ?>" target="_blank" class="social-link"> <i class="fab fa-youtube social-link-icon"></i> </a>
                                                        </li>
                                                        <?php
                                                            }
                                                        ?>
                                    ...
                                    <div class="sidebar-entry-course-info">
                                        ...
                                        <div class="course-meta">
                                            <div class="course-instructor">
                                                ...
                                                <span class="meta-value"><?= $virtual_assistant['name'] ?></span>
                                            </div>
